...
const (
	...
	User_LoginUser_FullMethodName    = "/service.User/LoginUser"
)
...
func (c *userClient) LoginUser(ctx context.Context, in *UserLoginRequest, opts ...grpc.CallOption) (*UserLoginResponse, error) {
